        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#" className="text-gray-700 hover:text-blue-600">Gia sư</a>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><a href="#" className="hover:text-white">Tìm gia sư</a></li>
                <li><a href="#" className="hover:text-white">Khóa học</a></li>
                <li><a href="#" className="hover:text-white">Tư vấn</a></li>
              </ul>
            </div>
            <div>
